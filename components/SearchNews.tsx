  ...
  return (
    <div className="space-y-12">
      <form className="premium-card p-8 bg-card" onSubmit={(e) => e.preventDefault()}>
        <div className="text-lg font-bold mb-6">全文搜索</div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-2">
            <label className="text-xs font-bold uppercase tracking-wider text-muted">正文关键词</label>
            <input
              value={keyword}
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-20 premium-card bg-card/50 border-dashed">
          <p className="text-muted text-lg">没有匹配的结果，试试更换关键词。</p>
        </div>
      ) : (
